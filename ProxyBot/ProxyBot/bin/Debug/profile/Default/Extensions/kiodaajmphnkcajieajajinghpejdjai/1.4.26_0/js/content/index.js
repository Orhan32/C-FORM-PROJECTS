...
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
const { addScript } = __webpack_require__(1);
const { injection } = __webpack_require__(8)
// @ts-ignore
__webpack_require__(9);

const regex = /[^\/]+\.+[edu|gov]+(?:[:\/.]|$)/;// regex to filter out .edu and .gov domain
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.config === "sendConfig") {
        ...
        (function ($) {
            ...
            if (!whitelist.includes(domain) && !whitelist.includes(domainWww) && regex.exec(domainWww) === null) {
